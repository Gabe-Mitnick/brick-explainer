...
const ENGLISH_CROSS: SceneState = {
	...BASE,
	bondPattern: 'englishCross',
	numWythes: 2,
	rows: 6,
	cols: 6,
	wytheSeparation: 0,
...
export const moments: Moment[] = [
	...
	// Moment 2: courses highlight one by one (auto-wave)
	{
		...
		scene: { ...S1, highlightWaveActive: true },
	},
	// Moment 3: individual bricks highlight column by column (auto-wave)
	{
		...
		scene: { ...S1, highlightColWaveActive: true },
	},
	{
		isSubstep: false,
	...
	},
	{
		...
		scene: { ...S2_CLOSE, splitProgress: 1 },
	},
	{
		isSubstep: false,
	...
	},
	{
		...
		scene: { ...ENGLISH, headerDarkenProgress: 1 },
	},
	{
		isSubstep: false,
